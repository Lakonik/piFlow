...
name = 'gmflux_k8_datafree_piid_4step_test'
...
model = dict(
    ...
    diffusion=dict(
        ...
        denoising=dict(
            ...
            pretrained_adapter='huggingface://Lakonik/pi-FLUX.1/gmflux_k8_datafree_piid_4step/diffusion_pytorch_model.safetensors',
            num_gaussians=8,
