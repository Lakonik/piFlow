...
name = 'gmqwen_k8_datafree_piid_4step_test'
...
model = dict(
    ...
    diffusion=dict(
        ...
        denoising=dict(
            ...
            pretrained_adapter='huggingface://Lakonik/pi-Qwen-Image/gmqwen_k8_datafree_piid_4step/diffusion_pytorch_model.safetensors',
            num_gaussians=8,
