...
model = dict(
    ...
    diffusion=dict(
        ...
        denoising=dict(
            ...
            pretrained_lora='huggingface://lightx2v/Qwen-Image-Lightning/Qwen-Image-Lightning-4steps-V1.0.safetensors',
            in_channels=64,
            out_channels=64,
            num_layers=60,
