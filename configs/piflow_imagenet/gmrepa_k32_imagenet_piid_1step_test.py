name = 'gmrepa_k32_imagenet_piid_1step_test'
...
model = dict(
    ...
    diffusion=dict(
        ...
        denoising=dict(
            ...
            pretrained='huggingface://Lakonik/pi-Flow-ImageNet/gmrepa_k32_imagenet_piid_1step/diffusion_pytorch_model.safetensors',
            num_gaussians=32,
